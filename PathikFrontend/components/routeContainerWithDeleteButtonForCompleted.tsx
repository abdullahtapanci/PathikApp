...
export default function routeContainerWithDeleteButtonforCompleted({ id, name, imagePath, stars, country, city, onPress }: Props) {
        ...
        <Pressable onPress={onPress}>
            ...
            <View style={styles.container}>
                ...
                <View style={{display: "flex", flexDirection:"row", justifyContent:"space-between", alignItems:"center"}}>
                    ...
                    <Button onPress={()=>handleUpdateIsComplete(id, 0)}><Feather name="corner-down-left" size={24} color="white" /></Button>
